#if !defined(ttDMCycleNew_H) && !defined(__CINT__)
#define ttDMCycleNew_H

#include "SFrameTools/include/AnalysisModule.h"
#include <memory>

/**
 *   @short ttDM of an analysis cycle, new version using AnalysisModule
 */
class ttDMCycleNew : public AnalysisModule {
public:
